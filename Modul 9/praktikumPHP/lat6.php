...
<body>
  ...
  if (isset($_POST['submit'])) { //pengecekan jika diproses tombol submit, maka bernilai true
    ...
    $mk = $_POST['mk']; //variabel untuk mengambil nilai data combobox mata kuliah
    $jk = $_POST['jk']; //variabel untuk mengambil nilai data radio button jenis kelamin
    $email = $_POST['email']; //variabel untuk mengambil nilai dari text email

    echo "INI OUTPUT SESUAI LAPORAN DARI FORM DIATAS <br/>";
    echo "Nama : " . $nama;
